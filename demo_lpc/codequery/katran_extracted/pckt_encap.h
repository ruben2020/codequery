...
__attribute__ ((__always_inline__)) static inline bool encap_v6 (struct __sk_buff *xdp, struct ctl_value *cval, bool is_ipv6, struct packet_description *pckt, struct real_definition *dst, __u32 pkt_bytes) {
    ...
    __u32 saddr [4];
    __u8 proto;
    if (bpf_skb_adjust_room (xdp, 0 - (int) sizeof (struct ipv6hdr), BPF_ADJ_ROOM_MAC, BPF_F_ADJ_ROOM_ENCAP_L3_IPV4)) {
        return false;
    }
...
__attribute__ ((__always_inline__)) static inline bool encap_v4 (struct __sk_buff *xdp, struct ctl_value *cval, struct packet_description *pckt, struct real_definition *dst, __u32 pkt_bytes) {
    void *data;
    void *data_end;
    struct iphdr *iph;
    struct ethhdr *new_eth;
    ...
    if (bpf_skb_adjust_room (xdp, 0 - (int) sizeof (struct iphdr), BPF_ADJ_ROOM_MAC, BPF_F_ADJ_ROOM_ENCAP_L3_IPV4)) {
        return false;
    }
    data = (void *) (long) xdp->data;
    data_end = (void *) (long) xdp->data_end;
...
__attribute__ ((__always_inline__)) static inline bool decap_v4 (struct __sk_buff *xdp, void **data, void **data_end) {
    struct ethhdr *new_eth;
    struct ethhdr *old_eth;
    old_eth = *data;
    ...
    memcpy (new_eth -> h_dest, old_eth -> h_dest, 6);
    new_eth->h_proto = BE_ETH_P_IP;
    if (bpf_skb_adjust_room (xdp, (int) sizeof (struct iphdr), BPF_ADJ_ROOM_MAC, BPF_F_ADJ_ROOM_ENCAP_L3_IPV4)) {
        return false;
    }
    *data = (void *) (long) xdp->data;
    *data_end = (void *) (long) xdp->data_end;
...
__attribute__ ((__always_inline__)) static inline bool gue_encap_v4 (struct __sk_buff *xdp, struct ctl_value *cval, struct packet_description *pckt, struct real_definition *dst, __u32 pkt_bytes) {
    void *data;
    void *data_end;
    struct iphdr *iph;
    struct udphdr *udph;
    ...
    if (bpf_skb_adjust_room (xdp, 0 - ((int) sizeof (struct iphdr) + (int) sizeof (struct udphdr)), BPF_ADJ_ROOM_MAC, BPF_F_ADJ_ROOM_ENCAP_L3_IPV4)) {
        return false;
    }
    data = (void *) (long) xdp->data;
    data_end = (void *) (long) xdp->data_end;
...
__attribute__ ((__always_inline__)) static inline bool gue_encap_v6 (struct __sk_buff *xdp, struct ctl_value *cval, bool is_ipv6, struct packet_description *pckt, struct real_definition *dst, __u32 pkt_bytes) {
    void *data;
    void *data_end;
    struct ipv6hdr *ip6h;
    struct ethhdr *new_eth;
    ...
    if (bpf_skb_adjust_room (xdp, 0 - ((int) sizeof (struct ipv6hdr) + (int) sizeof (struct udphdr)), BPF_ADJ_ROOM_MAC, BPF_F_ADJ_ROOM_ENCAP_L3_IPV4)) {
        return false;
    }
    data = (void *) (long) xdp->data;
    data_end = (void *) (long) xdp->data_end;
...
__attribute__ ((__always_inline__)) static inline bool gue_decap_v4 (struct __sk_buff *xdp, void **data, void **data_end) {
    struct ethhdr *new_eth;
    struct ethhdr *old_eth;
    old_eth = *data;
    ...
    memcpy (new_eth -> h_dest, old_eth -> h_dest, 6);
    new_eth->h_proto = BE_ETH_P_IP;
    if (bpf_skb_adjust_room (xdp, (int) (sizeof (struct iphdr) + sizeof (struct udphdr)), BPF_ADJ_ROOM_MAC, BPF_F_ADJ_ROOM_ENCAP_L3_IPV4)) {
        return false;
    }
    *data = (void *) (long) xdp->data;
    *data_end = (void *) (long) xdp->data_end;
...
__attribute__ ((__always_inline__)) static inline bool gue_decap_v6 (struct __sk_buff *xdp, void **data, void **data_end, bool inner_v4) {
    struct ethhdr *new_eth;
    struct ethhdr *old_eth;
    old_eth = *data;
    ...
    if (bpf_skb_adjust_room (xdp, (int) (sizeof (struct ipv6hdr) + sizeof (struct udphdr)), BPF_ADJ_ROOM_MAC, BPF_F_ADJ_ROOM_ENCAP_L3_IPV4)) {
        return false;
    }
    *data = (void *) (long) xdp->data;
    *data_end = (void *) (long) xdp->data_end;
