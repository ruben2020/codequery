...
#endif
int parse_hdr_opt (const struct __sk_buff *xdp, struct hdr_opt_state *state) {
...
__attribute__ ((__always_inline__)) static inline int tcp_hdr_opt_lookup (const struct __sk_buff *xdp, bool is_ipv6, struct real_definition **real, struct packet_description *pckt, bool bypass_lru, void *lru_map) {
    const void *data = (void *) (long) xdp->data;
    const void *data_end = (void *) (long) xdp->data_end;
