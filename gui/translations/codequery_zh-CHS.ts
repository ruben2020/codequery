<?xml version="1.0" encoding="utf-8"?>
    ...
    <location filename="../fileviewer.cpp" line="344"/>
        ...
        <translation>请输入路径和参数的外部编辑器。文件名和行号为 %n 使用 %f。例如，gedit %f + %n</translation>
    </message>
    <message>
