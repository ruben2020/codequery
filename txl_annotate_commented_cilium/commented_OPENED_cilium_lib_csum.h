...
/* 
 ...
 File: /home/sayandes/codequery/cilium/lib/csum.h
 Startline: 29
 Endline: 49 
 Funcname: csum_l4_offset_and_flags 
 Input: (__u8 nexthdr, struct csum_offset *off) 
 Output: void 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
...
/* 
 ...
 Input: (struct __ctx_buff *ctx, __u64 l4_off, const struct csum_offset *csum, __be32 from, __be32 to, int flags) 
 Output: int 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
