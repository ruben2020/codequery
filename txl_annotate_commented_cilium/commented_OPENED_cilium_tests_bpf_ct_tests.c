...
/* 
 ...
 File: /home/sayandes/codequery/cilium/tests/bpf_ct_tests.c
 Startline: 22
 Endline: 81 
 Funcname: mkpkt 
 Input: (void *dst, bool first) 
 Output: int 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
...
/* 
 ...
 Startline: 85
 Endline: 212 
 Funcname: test_ct4_rst1_check 
 Input: (__maybe_unused struct __ctx_buff *ctx) 
 Output: int 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
