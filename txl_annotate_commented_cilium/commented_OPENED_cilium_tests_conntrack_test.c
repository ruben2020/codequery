...
/* 
 ...
 File: /home/sayandes/codequery/cilium/tests/conntrack_test.c
 Startline: 30
 Endline: 33 
 Funcname: advance_time 
 Input: (void) 
 Output: void 
 Helpers: [] 
 Read_maps: [] 
...
/* 
 ...
 Endline: 39 
 Funcname: timeout_in 
 Input: (const struct ct_entry *entry, int seconds) 
 Output: bool 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
...
/* 
 ...
 Endline: 207 
 Funcname: bpf_test 
 Input: (__maybe_unused struct __sk_buff *sctx) 
 Output: int 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
