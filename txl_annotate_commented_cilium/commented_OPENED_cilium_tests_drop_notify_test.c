...
/* 
 ...
 File: /home/sayandes/codequery/cilium/tests/drop_notify_test.c
 Startline: 47
 Endline: 52 
 Funcname: mock_tail_call 
 Input: (void *ctx, __maybe_unused const void *map, __maybe_unused __u32 index) 
 Output: void 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
...
/* 
 ...
 Startline: 56
 Endline: 65 
 Funcname: test_send_drop_notify 
