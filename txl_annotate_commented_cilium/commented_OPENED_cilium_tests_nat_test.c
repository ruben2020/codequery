...
/* 
 ...
 File: /home/sayandes/codequery/cilium/tests/nat_test.c
 Startline: 52
 Endline: 61 
 Funcname: mock_ct_lookup4 
 Input: (__maybe_unused const void *map, __maybe_unused struct ipv4_ct_tuple *tuple, __maybe_unused struct __ctx_buff *ctx, __maybe_unused int off, __maybe_unused enum ct_dir dir, __maybe_unused struct ct_state *ct_state, __maybe_unused __u32 *monitor) 
 Output: int 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
...
/* 
 ...
 Startline: 64
 Endline: 74 
 Funcname: mock_ct_create4 
 Input: (__maybe_unused const void *map_main, __maybe_unused const void *map_related, __maybe_unused struct ipv4_ct_tuple *tuple, __maybe_unused struct __ctx_buff *ctx, __maybe_unused const int dir, __maybe_unused const struct ct_state *ct_state, __maybe_unused bool proxy_redirect, __maybe_unused bool from_l7lb) 
 Output: int 
 Helpers: [] 
 Read_maps: [] 
 Update_maps: [] 
