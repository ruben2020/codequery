...
dir/b/a/s
candle.exe -ext WixUIExtension -ext WixUtilExtension "c:\workspace\codequery\windows-install\qt6\codequeryqt6111.wxs"
light.exe -ext WixUIExtension -ext WixUtilExtension codequeryqt6111.wixobj
